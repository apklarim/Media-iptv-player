...
class ChannelListActivity : AppCompatActivity() {
    ...
    private var selectedGroupButton: Button? = null
    ...
    private fun addGroupButton(title: String, action: () -> Unit) {
        ...
        button.setOnLongClickListener {
            ...
            AlertDialog.Builder(this)
                ...
                .setNegativeButton("Tümünü Gizle") { _, _ ->

                    HiddenGroupsManager.clearHiddenGroups(this)

                    groups.forEach {
                        HiddenGroupsManager.hideGroup(this, it)
                    }
