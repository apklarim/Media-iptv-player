...
class GroupManagerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnHideSelected = findViewById(R.id.btnHideSelected)

        groups = ChannelRepository.channels
            .map { it.group }
            .distinct()
            .filter { it.isNotEmpty() }
            .sorted()

        listGroups.choiceMode = ListView.CHOICE_MODE_MULTIPLE
