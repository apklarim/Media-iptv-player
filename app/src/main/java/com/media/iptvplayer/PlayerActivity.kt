...
class PlayerActivity : AppCompatActivity() {
    ...
    private fun toggleFavorite() {
        ...
        android.widget.Toast.makeText(
            this,
            "Favori durumu değiştirildi: ${channel.name}",
            android.widget.Toast.LENGTH_SHORT
        ).show()
    }
    ...
    private fun showChannelInfo() {
        ...
        val info = buildString {
            ...
            append("Kanal: ${channel.name}\n\n")
            append("Grup: ${channel.group}\n\n")
            ...
            if (videoFormat != null) {
                ...
                append("Video Codec: ")
                append(videoFormat.sampleMimeType ?: "Bilinmiyor")
                append("\n\n")
            }
