...
class PlayerActivity : AppCompatActivity() {
    ...
    private fun startChannel(channel: Channel) {
        ...
        val mediaItem = when {
            ...
            url.contains("kool.to", true) ||
            url.contains("fobembox", true) ->
    ...
    private fun showControlsTemporarily() {
        ...
        findViewById<View>(R.id.channelInfoBar)
            .visibility = View.VISIBLE

        findViewById<View>(R.id.playerButtonsContainer)
            .visibility = View.VISIBLE
        ...
        when (keyCode) {
            ...
            in KeyEvent.KEYCODE_0..KeyEvent.KEYCODE_9 -> {
                ...
                numberHandler.postDelayed({
                    ...
                    val channelNumber = numberBuffer.toIntOrNull() ?: 0

                    if (channelNumber > 0 &&
                        channelNumber <= channels.size) {

                        currentIndex = channelNumber - 1
                        playChannel(currentIndex)
                    }
